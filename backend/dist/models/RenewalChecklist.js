...
const RenewalChecklistSchema = new mongoose_1.Schema({
    userId: {
    ...
    academicUpdate: {
        ...
        transcriptFileId: mongoose_1.Schema.Types.ObjectId,
    },
    employmentUpdate: {
        isEmployed: { type: Boolean, required: true },
        employer: String,
        hoursPerWeek: Number,
        verificationFileId: mongoose_1.Schema.Types.ObjectId,
    },
    complianceChecklist: {
...
exports.default = mongoose_1.default.model("RenewalChecklist", RenewalChecklistSchema);
